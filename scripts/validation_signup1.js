document.addEventListener("DOMContentLoaded", () => {
  ...
  function storeFormData() {
    ...
    let selectedLocation = document.querySelector(
      'input[name="signupLocation"]:checked'
    );
    if (selectedLocation) {
  ...
  function retrieveFormData() {
    if (sessionStorage.getItem("signupFirstName")) {
      document.getElementById("signupFirstName").value =
        sessionStorage.getItem("signupFirstName");
    }
    if (sessionStorage.getItem("signupLastName")) {
      document.getElementById("signupLastName").value =
        sessionStorage.getItem("signupLastName");
    }
    ...
    if (storedLocation) {
      let radioToCheck = document.querySelector(
        `input[name="signupLocation"][value="${storedLocation}"]`
      );
      if (radioToCheck) {
